...
lakehouse_path = "Files/trends-parquet/noor2/noor2/SCSENG"
...
#===========================================================
# Total number of files in Files/trends-parquet/noor2: 11 files, this is the size: 23,897,643,618 bytes (22.26 GB)

# Total number of files in Files/trends-parquet/noor2/noor2/DCSENG: 6 files, this is the size: 5,620,418,397 bytes (5.23 GB)
# Total number of files in Files/trends-parquet/noor2/noor2/SCSENG: 5 files, this is the size: 18,277,225,221 bytes (17.02 GB)
...
# ------------------------------------------------------------
lakehouse_folder = "Files/trends-parquet/noor2/noor2/SCSENG"
...
# ------------------------------------------------------------
target_table = "IIoT_Silver_lakehouse.noor2.iot_noor2_brnz_SCSENG"
(
    df.write
        .format("delta")
...
source_table = "IIoT_Silver_lakehouse.noor2.iot_noor2_brnz_SCSENG"
...
target_table = "IIoT_Silver_lakehouse.noor2.iot_noor2_slvr_SCSENG"
#overwrite   append
df_final.write \
     .format("delta") \
     .mode("overwrite") \

...
lakehouse_path = "Files/dewa5/1-min/2025/11"
...
# 2,691.23 GB | 2,705,422 file ===>>> 83.92 GB parquet (3.12%) | 6,517,102,423 record ===>>> 83.92 GB  (3.12%)
#----------------------------------------------------------------------------------------------------------------
# Total number of files in Files/dewa5/1-min/2025/07:    40,309 files, this is the size: (   12.02 GB) |    32,057,927 record   0.33 GB
# Total number of files in Files/dewa5/1-min/2025/08:   470,800 files, this is the size: (  509.62 GB) | 1,238,545,795 record  16.42 GB
# Total number of files in Files/dewa5/1-min/2025/09: 1,121,451 files, this is the size: (1,102.21 GB) | 2,666,208,039 record  50.71 GB
# Total number of files in Files/dewa5/1-min/2025/10: 1,072,862 files, this is the size: (1,067.38 GB) | 2,580,290,662 record  83.92 GB
# Total number of files in Files/dewa5/1-min/2025/11:   774,349 files, this is the size: (  740.46 GB) | 1,787,171,381 record 120.12 GB

# Total number of files in Files/dewa5/Historical   :         1 files, this is the size: (   10.78 GB) |    74,649,235 record   0.65 GB
...
table_name = "IIoT_Bronze_lakehouse.dewa5.iot_dewa5"
...
# ------------------------------------------------------------
lakehouse_folder = "Files/dewa5/1-min/2025/11"
...
# ------------------------------------------------------------
target_table = "IIoT_Bronze_lakehouse.dewa5.iot_dewa5"
(
    df.write
        .format("delta")
...
CSV_FOLDER_PATH = "Files/dewa5/Historical"
...
target_table = "IIoT_Bronze_lakehouse.dewa5.iot_dewa5_csv"
...
source_table = "IIoT_Bronze_Lakehouse.dewa5.iot_dewa5"
...
target_table = "IIoT_Silver_Lakehouse.dewa5.iot_dewa5"
#overwrite   append
df_final.write \
     .format("delta") \
     .mode("overwrite") \
...
# 3️⃣ Read the source table
source_table = "IIoT_Bronze_Lakehouse.dewa5.iot_dewa5_csv"
df = spark.read.table(source_table)
...
spark.sql("""
    DELETE FROM IIoT_Silver_Lakehouse.dewa5.iot_dewa5_streams
    WHERE SignalDate IN ('2025-06-28')
""")
...
spark.sql("""
    INSERT INTO IIoT_Silver_lakehouse.dewa5.iot_dewa5
...
SELECT 
    ...
    Value_Text,
    Value_Type
FROM IIoT_Silver_lakehouse.dewa5.iot_dewa5_streams

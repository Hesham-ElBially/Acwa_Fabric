...
lakehouse_path = "Files/redstone/1-min/2025/11"
...
# 702.3 GB | 556,830 file ===>>> 18.57 GB parquet (3.13%) | 1,151,350,292 record ===>>> 1,825,596,146 record 6.81 GB  (0.97%)
#----------------------------------------------------------------------------------------------------------------
# Total number of files in Files/redstone/1-min/2025/07: 125,385 files, this is the size: ( 47.27 GB) | 114,419,626 record  1.88 GB
# Total number of files in Files/redstone/1-min/2025/09: 103,603 files, this is the size: (108.45 GB) | 250,574,018 record  5.16 GB
# Total number of files in Files/redstone/1-min/2025/10: 327,839 files, this is the size: (340.44 GB) | 786,356,648 record 15.53 GB
# Total number of files in Files/redstone/1-min/2025/11:  96,869 files, this is the size: (100.45 GB) | 232,005,026 record 18.57 GB

# Total number of files in Files/redstone/Historical   :       1 files, this is the size: ( 73.28 GB) | 442,240,828 record  4.84 GB
# Total number of files in Files/MongoDB/redstone      :       2 files, this is the size: (132.86 GB) | 938,793,149 record  5.83 GB
...
table_name = "IIoT_Silver_Lakehouse.redstone.iot_redstone"
...
# ------------------------------------------------------------
lakehouse_folder = "Files/redstone/1-min/2025/11"
...
# ------------------------------------------------------------
target_table = "IIoT_Bronze_lakehouse.redstone.iot_redstone"
(
    df.write
        .format("delta")
...
CSV_FOLDER_PATH = "Files/redstone/Historical"
...
target_table = "IIoT_Bronze_lakehouse.redstone.iot_redstone_csv"
...
source_table = "IIoT_Bronze_Lakehouse.redstone.iot_redstone"
...
target_table = "IIoT_Silver_Lakehouse.redstone.iot_redstone"
#overwrite   append
df_final.write \
     .format("delta") \
     .mode("overwrite") \
...
# 3️⃣ Read the source table
source_table = "IIoT_Bronze_Lakehouse.redstone.iot_redstone_csv"
df = spark.read.table(source_table)

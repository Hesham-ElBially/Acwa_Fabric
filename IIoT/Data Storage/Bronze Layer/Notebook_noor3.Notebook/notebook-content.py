...
lakehouse_path = "Files/trends-parquet/noor3"
...
#===========================================================
# Total number of files in Files/trends-parquet/noor3: 6 files, this is the size: 9,554,953,591 bytes (8.90 GB)
...
# ------------------------------------------------------------
lakehouse_folder = "Files/trends-parquet/noor3"
...
# ------------------------------------------------------------
target_table = "IIoT_Silver_lakehouse.noor3.iot_noor3_brnz_DCSENG"
(
    df.write
        .format("delta")
...
source_table = "IIoT_Silver_lakehouse.noor3.iot_noor3_brnz_DCSENG"
...
target_table = "IIoT_Silver_lakehouse.noor3.iot_noor3_slvr_DCSENG"
#overwrite   append
df_final.write \
     .format("delta") \
     .mode("overwrite") \

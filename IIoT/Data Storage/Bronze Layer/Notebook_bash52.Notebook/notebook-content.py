...
lakehouse_path = "Files/iot-raw-data-json/bash52/1-min/2026/01/18"
...
# ------------------------------------------------------------
lakehouse_folder = "Files/iot-raw-data-json/bash52/1-min/2026/01"
...
# ------------------------------------------------------------
target_table = "IIoT_Silver_Lakehouse.bash52.iot_bash52XXX"
(
    df.write
        .format("delta")
...
source_table = "IIoT_Silver_Lakehouse.bash52.iot_bash52XXX"
...
target_table = "IIoT_Silver_Lakehouse.bash52.iot_bash52yyy"
#overwrite   append
df_final.write \
     .format("delta") \
     .mode("overwrite") \
...
SELECT 
    ...
    Value_Text,
    Value_Type
FROM IIoT_Silver_lakehouse.bash.iot_bash_streams
